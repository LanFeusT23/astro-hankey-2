      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
          ...
          <div class="flex items-center gap-4">
            <div class="flex items-center gap-3 bg-space-800/60 border border-space-700/50 rounded-full px-4 py-2">
              <div class="w-8 h-8 rounded-full bg-nebula-600 flex items-center justify-center text-white text-sm font-medium">
                {{ userInitial }}
              </div>
        ...
        <div class="bg-space-800/40 border border-space-700/40 rounded-2xl p-6 mb-8 backdrop-blur-sm">
          ...
          <form @submit.prevent="handleUpload" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
              ...
              >
                ...
                <svg class="w-10 h-10 mx-auto text-slate-500 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
